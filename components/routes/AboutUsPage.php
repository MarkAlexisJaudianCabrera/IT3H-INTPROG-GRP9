    ...
    <div class="" style="margin-top:10rem;">
        <!-- contents dito -->
         <div class="AboutUs">
            ...
            <br>
            <div class="AboutUs-portal-contents">
                <div class="AboutUs-portal-title">
                    <h4>About the Healthcare Portal</h4>
                </div>

                <div class="AboutUs-portal-desc">
                    <p>
                        The Healthcare Portal is a one-stop online platform that offers a wide 
                        range of healthcare-related services. Key features include:
                    </p>
                    <ul>
                        <li>
            ...
            <br>
            <div class="AboutUs-help-contents">
                <div class="AboutUs-help-title">
                    <h4>How We Can Help?</h4>
                </div>
                <div class="AboutUs-help-desc">
                    <p>
                        The Healthcare Portal is designed to benefit students, faculty, and staff in several ways:
                    </p>
                    <ul>
                        <li>
